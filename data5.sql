...
BEGIN TRANSACTION;
INSERT INTO [dbo].[Kategorija]([ID], [Name])
SELECT 1, N'Kriptografija' UNION ALL
SELECT 2, N'Informacioni sistemi' UNION ALL
SELECT 3, N'Analiza algoritama' UNION ALL
SELECT 4, N'Istrazivanje podataka' UNION ALL
SELECT 5, N'Vestacka inteligencija' UNION ALL
SELECT 6, N'Programski jezici' UNION ALL
SELECT 7, N'Naucno izracunavanje' UNION ALL
SELECT 8, N'Programske paradigme' UNION ALL
SELECT 9, N'Bioinformatika'
COMMIT;
RAISERROR (N'[dbo].[Kategorija]: Insert Batch: 1.....Done!', 10, 1) WITH NOWAIT;
GO
